...
6. `UX_AND_PAYMENTS_FLOW.md`
7. `UX_PRINCIPLES.md`
8. `USER_FLOWS.md`
9. `FRONTEND_VISION.md`
10. `WIREFRAMES.md`
11. `COMPETITOR_MATRIX.md`
12. `STATE_MODEL.md`
13. `TASKMARKET_COMPATIBILITY.md`
14. `GO_NO_GO_SCORECARD.md`
15. `CANNES_2026_VARIANT.md`
16. `CANNES_2026_PRIZE_MAPPING.md`
17. `CANNES_2026_MVP_SPEC.md`
18. `CANNES_2026_TASKS.md`
19. `CANNES_2026_ACCEPTANCE_TEST_MATRIX.md`
20. `CANNES_2026_EDGE_CASES.md`
21. `CANNES_2026_DEPLOYMENT_AND_DEMO.md`
22. `CANNES_2026_FIRST_60_MINUTES.md`
23. `CANNES_2026_ADVERSARIAL_REVIEW.md`
...
- Current state and parity: `SPEC_PARITY`
...
- Token design (current build): `TOKEN_ARCHITECTURE`, `TOKENOMICS`, `TOKEN_HANDOFF_PACKAGE`
...
- One-shot build assets: `contracts/`, `fixtures/`, `ACCEPTANCE_TEST_MATRIX.md`, `CANNES_2026_FIRST_60_MINUTES.md`
- Historical process docs: `archive/README.md`
